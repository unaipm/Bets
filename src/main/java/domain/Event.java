...
public class Event implements Serializable {
	...
	public Event(String description,Date eventDate, Equipo eq1, Equipo eq2) {
		this.description = description;
		this.eventDate=eventDate;
		this.setEstado(true);
		this.setEstadoPublico(true);
		this.setEq1(eq1);
		this.setEq2(eq2);
	}
	...
	public String toString(){
		return description+";"+eq1.toString()+"-"+eq2.toString();
	}
	 ...
	 * @return Bet
	 */
	public Question addQuestion(String question, float betMinimum, boolean equipo)  {
        Question q=new Question(question,betMinimum, this, equipo);
